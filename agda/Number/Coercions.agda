...
module Coerce-ℕ↪ℤ where
  ...
  private f = ℕ↪ℤ
  abstract
    coerce-ℕ↪ℤ : ∀{p} → (x : Number (isNat ,, p)) → Ip isInt (availablePositivity isInt p) (ℕ↪ℤ (num x))
...
module Coerce-ℕ↪ℚ where
  ...
  private f = ℕ↪ℚ
  abstract
    coerce-ℕ↪ℚ : ∀{p} → (x : Number (isNat ,, p)) → Ip isRat (availablePositivity isRat p) (ℕ↪ℚ (num x))
...
module Coerce-ℕ↪ℝ where
  ...
  private f = ℕ↪ℝ
  abstract
    coerce-ℕ↪ℝ : ∀{p} → (x : Number (isNat ,, p)) → Ip isReal (availablePositivity isReal p) (ℕ↪ℝ (num x))
...
module Coerce-ℤ↪ℚ where
  ...
  private f = ℤ↪ℚ
  abstract
    coerce-ℤ↪ℚ : ∀{p} → (x : Number (isInt ,, p)) → Ip isRat (availablePositivity isRat p) (ℤ↪ℚ (num x))
...
module Coerce-ℤ↪ℝ where
  ...
  private f = ℤ↪ℝ
  abstract
    coerce-ℤ↪ℝ : ∀{p} → (x : Number (isInt ,, p)) → Ip isReal (availablePositivity isReal p) (ℤ↪ℝ (num x))
...
module Coerce-ℤ↪ℂ where
  ...
  private f = ℤ↪ℂ
  abstract
    coerce-ℤ↪ℂ : ∀{p} → (x : Number (isInt ,, p)) → Ip isComplex (availablePositivity isComplex p) (ℤ↪ℂ (num x))
...
module Coerce-ℚ↪ℝ where
  ...
  private f = ℚ↪ℝ
  abstract
    coerce-ℚ↪ℝ : ∀{p} → (x : Number (isRat ,, p)) → Ip isReal (availablePositivity isReal p) (ℚ↪ℝ (num x))
...
module Coerce-ℚ↪ℂ where
  ...
  private f = ℚ↪ℂ
  abstract
    coerce-ℚ↪ℂ : ∀{p} → (x : Number (isRat ,, p)) → Ip isComplex (availablePositivity isComplex p) (ℚ↪ℂ (num x))
...
module Coerce-ℝ↪ℂ where
  ...
  private f = ℝ↪ℂ
  abstract
    coerce-ℝ↪ℂ : ∀{p} → (x : Number (isReal ,, p)) → Ip isComplex (availablePositivity isComplex p) (ℝ↪ℂ (num x))
